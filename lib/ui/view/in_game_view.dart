    ...
    return BlocBuilder<TakeOrPassDialogBloc, TakeOrPassState>(
      ...
      if (takeOrPassState is PlayerPassed) {
        ...
        if (nextPlayer.isRealPlayer) {
          BlocProvider.of<TakeOrPassDialogBloc>(context).add(RealPlayerTurn(nextPlayer, takeOrPassState.gameContext.lastTurn));
        } else {
          BlocProvider.of<TakeOrPassDialogBloc>(context).add(Pass(nextPlayer));
        }
      }
      return Container(
        child: Scaffold(
